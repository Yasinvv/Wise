...
export std::pair<vk::raii::PipelineLayout, vk::raii::Pipeline>
createGraphicsPipeline(VK_CTX& ctx,
                       const vk::raii::DescriptorSetLayout& descriptorSetLayout,
                       const PipelineConfigs& configs) {
  vk::raii::ShaderModule shaderModule =
      WisE::createShaderModule(WisE::readFile(configs.shaderPath), ctx.device);
